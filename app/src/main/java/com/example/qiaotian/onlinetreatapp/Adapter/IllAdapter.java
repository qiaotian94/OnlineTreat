...
public class IllAdapter extends RecyclerView.Adapter<IllAdapter.ViewHolder> {

private List<String> date=new ArrayList<>();
//构造器，接受数据集
public IllAdapter(List<String> date) {
        this.date = date;
        }


public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ill_item, parent, false);
        IllAdapter.ViewHolder holder = new IllAdapter.ViewHolder(view);
        return holder;
        }


public void onBindViewHolder(final IllAdapter.ViewHolder holder, int position) {
        //将数据填充到具体的view中
